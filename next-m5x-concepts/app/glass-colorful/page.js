  ...
  return (
    <main className="concept-page theme-glass-page theme-glass-colorful">
      ...
      <GlassHero
        ...
        variantClass="glass-hero-colorful glass-hero-colorful-full glass-hero-noise-off"
        introDelayMs={500}
        hideCopy
        leftSlideIntro
        aggressiveParallax
      ...
      <section className="glass-action-strip glass-action-strip-below-hero" id="hero-actions">
      ...
      <GlassContactSection variantClass="glass-contact-colorful" hideSocials hideMark />
    </main>
  );
}
